...
public class CreditoService {
  ...
  public List<CreditoDTO> findByNumeroNfse(String numeroNfse) {
    ...
    enviarEventoConsulta("NFSE", numeroNfse);
  ...
  public CreditoDTO findByNumeroCredito(String numeroCredito) {
    ...
    enviarEventoConsulta("CREDITO", numeroCredito);

    return creditoMapper.toCreditoDTO(credito);
  }

  private void enviarEventoConsulta(String tipoConsulta, String valorConsulta) {
    try {
      var evento =
